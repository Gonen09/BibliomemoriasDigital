...
<div class="container-fluid">
  <div class="row">
          ...
          <div class="panel-group" id="accordion">
            <div class="panel panel-default">
                <div class="panel-heading" id="busqueda-avanzada">
                    <h4 class="panel-title" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" id="p_avanzada"><a>Búsqueda avanzada</a></h4>
                </div>
                      ...
                      <div class="row">
                        <div class="col-sm-8" aling="center">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-xs-10">
                              <div class="input-group">
                                <input class="form-control" type="number" value="1990" id="q_ano">
    ...
    <div class="col-sm-3">
		...
		<div class="row" id= "contenedor_panal_y_resultados"> <!--Contenedor panal y resultados ------------------------------------------------------- -->

		
		
		</div> <!-- col-sm-6 --> <!--End contenedor panal y resultados ----------------------------------------------- -->
    </div> <!-- row content -->
</div> <!-- container-fluid -->
